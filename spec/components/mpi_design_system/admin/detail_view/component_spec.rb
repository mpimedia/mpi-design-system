...
RSpec.describe MpiDesignSystem::Admin::DetailView::Component, type: :component do
  ...
  it "composes with AvatarCircle in profile panel" do
    avatar_html = render_inline(MpiDesignSystem::Admin::AvatarCircle::Component.new(name: "Sarah Connor", size: :lg)).to_html
  ...
  it "composes with EngagementTimeline in activity panel" do
    ...
    timeline_html = render_inline(MpiDesignSystem::Admin::EngagementTimeline::Component.new(
