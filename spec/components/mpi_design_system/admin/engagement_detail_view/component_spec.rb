...
RSpec.describe MpiDesignSystem::Admin::EngagementDetailView::Component, type: :component do
  ...
  it "composes with BreadcrumbNav in breadcrumb slot" do
    breadcrumb_html = render_inline(
      MpiDesignSystem::Admin::BreadcrumbNav::Component.new(
  ...
  it "composes with EmailThread in main content slot" do
    thread_html = render_inline(
      MpiDesignSystem::Admin::EmailThread::Component.new(
