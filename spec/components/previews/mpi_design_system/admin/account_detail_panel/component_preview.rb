...
class MpiDesignSystem::Admin::AccountDetailPanel::ComponentPreview < ApplicationComponentPreview
  # @label Default
  def default
    render MpiDesignSystem::Admin::AccountDetailPanel::Component.new(
      name: "Sony Pictures",
