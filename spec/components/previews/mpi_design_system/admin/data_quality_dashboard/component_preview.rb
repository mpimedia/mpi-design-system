...
class MpiDesignSystem::Admin::DataQualityDashboard::ComponentPreview < ApplicationComponentPreview
  # @label Excellent
  def excellent
    render MpiDesignSystem::Admin::DataQualityDashboard::Component.new(
      overall_score: 92,
