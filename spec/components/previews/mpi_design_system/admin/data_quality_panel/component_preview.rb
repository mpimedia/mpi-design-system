...
class MpiDesignSystem::Admin::DataQualityPanel::ComponentPreview < ApplicationComponentPreview
  # @label Excellent
  def excellent
    render MpiDesignSystem::Admin::DataQualityPanel::Component.new(
      score: 92,
      tier: :excellent,
      fields_complete: 11,
      fields_total: 12,
      fields: [
        ...
        { name: "Tags", complete: true, priority: :med, value: "Acquisitions, Streaming" },
  ...
  def fair
    render MpiDesignSystem::Admin::DataQualityPanel::Component.new(
      ...
      fields: [
        ...
        { name: "Tags", complete: true, priority: :med, value: "Journalist" },
        { name: "Account", complete: false, priority: :med, add_url: "#" },
