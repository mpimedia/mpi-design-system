...
class MpiDesignSystem::Admin::EngagementTimeline::ComponentPreview < ApplicationComponentPreview
  # @label Default (Full)
  def default
    render MpiDesignSystem::Admin::EngagementTimeline::Component.new(
